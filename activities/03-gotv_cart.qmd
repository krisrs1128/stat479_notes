...
The block below reads in the data and renames the columns. The vector
...
from 0.31 to 0.38 (of course, these are just estimates -- can you think of how
to add error bars?).
...
0.29 to 0.36 among participants with some prior political engagement.
