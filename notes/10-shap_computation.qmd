...
regression suggests $v(\emptyset) \approx \beta_0$ and
   ...
   _Exercise: In fact, the regression objective ensures that $v\left(\emptyset\right) = \beta_0$ and $v(\mathcal{D}) - v(\emptyset) = \Delta$ hold exactly. Can you see why? (Hint: Consider the weights)_
