...
agents $\mathcal{D} = \{1, \dots, D\}$ where any <span
...
1. The marginal contributions become,
   ...
   \end{align*}
   $$
   This is the change in prediction when feature $d$ is included (top) vs.
   replaced by the baseline (bottom).
...
1. $^\dagger$ Some researchers [@janzing20a] have argued that point (4) in the
